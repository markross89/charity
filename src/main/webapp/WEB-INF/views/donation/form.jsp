    ...
    <header class="header--form-page" style="margin-top: 30px">
      ...
      <div class="slogan container container--90">
        <div class="slogan--item">
          <h1>
            <fmt:message key="donation.home.message"/>
          </h1>
          ...
          <div class="slogan--steps">
            ...
            <ul class="slogan--steps-boxes">
              <li>
                <div><em>1</em><span><fmt:message key="donation.step.one"/></span></div>
              </li>
              <li>
                <div><em>2</em><span><fmt:message key="donation.step.two"/></span></div>
              </li>
              <li>
                <div><em>3</em><span><fmt:message key="donation.step.three"/></span></div>
              </li>
              <li>
                <div><em>4</em><span><fmt:message key="donation.step.four"/></span></div>
              </li>
            </ul>
          </div>
        </div>
